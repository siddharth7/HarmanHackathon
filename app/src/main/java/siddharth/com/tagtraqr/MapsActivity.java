...
//        dataSource.open();
        ...
        spinner_nav.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapter, View v,
               ...
               latitude = Lati.get(position);
               longitude = Longi.get(position);
               Log.d("Latitude ","val"+latitude);
               Log.d("Longitude ","val"+longitude);
               setUpMap();
    ...
    private void setUpMap() {
        ...
        //String Device Name
        String DeviceName = "Bag";

        // Get latitude of the Database
        //double latitude=28.5466417;

        // Get longitude of the Database
        //double longitude = 77.272540;
        Log.d("Latitude ","val2"+latitude);
        Log.d("Longitude ","val2"+longitude);

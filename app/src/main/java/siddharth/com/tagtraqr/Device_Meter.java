...
/**
 * Created by siddharthsingh on 18/03/16.
 */
 ...
 */
public class Device_Meter extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mac_address=intent.getStringExtra("Device_Address");
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = Device_Meter.this.getLayoutInflater();
        }
                ...
                public void onLeScan(final BluetoothDevice device, final int rssi, byte[] scanRecord) {
                    if (device.getAddress().equals(mac_address)) {
                        ...
                        if (rssi < -100) //&& device.getAddress().equals(StatusAdapter.deviceAddress))
                        {
                            ...
                            PendingIntent pIntent = PendingIntent.getActivity(Device_Meter.this, 0, intent, 0);
                            Notification noti = new Notification.Builder(Device_Meter.this)
